...
- 명령 매뉴얼: `C:\Work\srcs\Tmax\manual\openframe_base\docs\modules\tool-reference-guide\pages\etc\sect-ofconfig.adoc`
- 설정 매뉴얼: 관련 제품 매뉴얼의 `configuration-guide`
- 명령 구현: `/opt/oframe/ofsrc/base/src/tool/ofconfig/ofconfig_main.c`
- 설정 공통 구현: `/opt/oframe/ofsrc/base/src/common/ofcom/ofcom_conf.c`
